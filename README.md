...
- Store a sequence of JSON object states as lines in a JSONL file
...
- `JDD_DIFFER` set diff tool/invocation; some options
    ...
    - [jd](https://github.com/josephburnett/jd), [json-diff](https://github.com/andreyvit/json-diff), [jsondiff](https://github.com/xlwings/jsondiff), [gojsondiff](https://github.com/yudai/gojsondiff), [difftastic](https://github.com/Wilfred/difftastic)
